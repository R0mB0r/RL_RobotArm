...
with open("Xarm6/distances.txt", "r") as file:
...
fig.add_trace(go.Scatter(x=steps, y=[0.005] * len(steps), mode='lines', name='Seuil de réussite', line=dict(color='red', dash='dash')))
